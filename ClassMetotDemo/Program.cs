...
namespace ClassMetotDemo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            MusteriManager.ekle(a1, 0,"Aslı","Han");//neden atadığım id işlenmiyor anlayamadım
            ...
            MusteriManager.sil(a1);//id int değer olarak atadığım için null yapamadım -2 yazarak geçersiz veri saydım
